...
// import BackError from "../../../public/error-404.png";
import {
  formatTime,
  formatGenres,
  formatComanies,
            ...
            <div className={styles.previewMovieHeader}>
              <div className={styles.previewMovieBackdrop}>
                {item.backdrop_path != null ? (
                  ...
                  <img
                    src="https://img.freepik.com/vetores-gratis/glitch-error-404-page_23-2148105404.jpg"
                    alt={
                      item.original_title
                        ? item.original_title
                        : item.original_name
                ...
                <div>
                  ...
                  <div className={styles.previewMovieSound}>
                    ...
                    >
                      {soundReleased ? <SoundOn /> : <SoundOff />}
                    </button>
                  </div>
                </div>
              </div>
                  ...
                  <div className={styles.previewMovieBodyDetailsRight}>
                    <div className={styles.tagsCompanies}>
                      ...
                      <span>
                        {companies === "" ? (
                          <>
                            Ops, não foi possível encontrar as produtoras desse
                            título.
                          </>
                        ) : (
                          <>{companies}</>
                        ...
                        <div className={styles.previewMovieTrackCard} key={key}>
                          <div className={styles.previewMovieTrackMain}>
                            <div className={styles.previewMovieTrackImage}>
                              {value.backdrop_path != null ? (
                                ...
                                <img
                                  src="https://github.com/gustavo-nt/netflix-clone/blob/master/public/error-back.png"
                                  alt={
                                    value.original_title
                                      ? value.original_title
                                      : value.original_name
                          ...
                          <div className={styles.previewMovieTrackDetails}>
                            <div className={styles.previewMovieTrackHeader}>
                              <div>
                                <div className={styles.tagsRelevance}>
                                  {value.vote_average * 10}% relevante
                                </div>
                                <div className={styles.tagsTitle}>
                                  {value.original_title.substring(0, 15) +
                                    "..."}
                                </div>
                              </div>
                              <button className={styles.previewMovieAddList}>
                            ...
                            <div
                              className={styles.previewMovieTrackDetailsBody}
                            >
                              <p>
                                {value.overview === "" ? (
                                  <>
                                    Ops...O título em questão, não possui uma
                                    descrição.
                                  </>
                                ) : (
                                  <>{value.overview}</>
